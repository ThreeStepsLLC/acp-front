    ...
    <div className='bg-[#001F3F]'>
        ...
        <div className='grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-8'>
            <div className="grid gap-4">
                <p className='text-[#ffffff] text-[18px] font-semibold flex gap-4'><Image src={'yellowLine.svg'} alt={'whatwedo'} height={1} width={40} /> WHY CHOOSE US</p>
                <p className='text-[#ffffff] text-[45px] font-bold'><span className='text-[#0DA574] text-[45px] font-bold'>Designing </span> Future with Excellence</p>
