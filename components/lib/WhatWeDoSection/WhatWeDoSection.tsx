  ...
  return (
    <div className='container mx-auto px-16 py-20'>
        ...
        <div className='grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-8'>
            ...
            <Card number={'03'} caption={'Lorem Ipsum'} content={'Morbi tincidunt ornare massa eget egestas purus viverra blandit elementum cursus risus.'} />
            <Card number={'04'} caption={'Lorem Ipsum'} content={'Ac tortor vitae purus faucibus ornare suspendisse sed nisi lacus. Nam aliquam sem et tortor '} />
            <Card number={'05'} caption={'Lorem Ipsum'} content={'Mollis nunc sed id semper. Sodales ut etiam sit amet nisl purus. Sed odio morbi quis commodo odio '} />
            <Card number={'06'} caption={'Lorem Ipsum'} content={'Tellus elementum sagittis vitae et. Amet justo donec enim diam vulputate ut consequat id porta nibh venenatis'} />
        </div>
    </div>
  )
}
