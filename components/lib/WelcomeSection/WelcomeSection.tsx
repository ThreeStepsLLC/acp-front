    ...
    >
      ...
      <div className="container mx-auto px-12 grid lg:grid-cols-1 md:grid-cols-1 sm:grid-cols-1 pb-10 relative">
        <div className="lg:py-10 lg:pt-16 pt-40 py-0">
          <p className="text-[#00517b] lg:text-[18px] md:text-[18px] text-[14px] font-semibold flex gap-4">
            <Image
              src={"yellowLine.svg"}
              alt={"whatwedo"}
              height={1}
          ...
          <p className="lg:text-[40px] md:text-[40px] text-[20px] font-extrabold text-[#00517b] mb-4">
            The power of engineering, at your service
          </p>
          <p className="lg:text-[20px] md:text-[20px] text-[15px] font-semibold text-[#ffffff]">
        ...
        <div className="grid grid-cols-4 gap-6 mt-20">
          <div className="grid lg:text-start md:text-start text-center mb-10">
            <p className="lg:text-[40px] md:text-[40px] text-[20px] font-bold text-[#81a32b]">8</p>
            <p className="lg:text-[19px] md:text-[19px] text-[16px] font-bold text-[#00517b]">Total Projects</p>
          </div>
          <div className="grid lg:text-start md:text-start text-center mb-10">
            <p className="lg:text-[40px] md:text-[40px] text-[20px] font-bold text-[#81a32b]">613km</p>
            <p className="lg:text-[19px] md:text-[19px] text-[16px] font-bold text-[#00517b]">Total Road</p>
          </div>
          <div className="grid lg:text-start md:text-start text-center mb-10">
            <p className="lg:text-[40px] md:text-[40px] text-[20px] font-bold text-[#81a32b]">12</p>
            <p className="lg:text-[19px] md:text-[19px] text-[16px] font-bold text-[#00517b]">Total Tunnels</p>
          </div>
          <div className="grid lg:text-start md:text-start text-center mb-10">
            <p className="lg:text-[40px] md:text-[40px] text-[20px] font-bold text-[#81a32b]">125</p>
            <p className="lg:text-[19px] md:text-[19px] text-[16px] font-bold text-[#00517b]">Total Bridges</p>
          </div>
        </div>
