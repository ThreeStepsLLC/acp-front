  ...
  return (
    <div className="bg-[#001F3F]">
      <div className="container mx-auto px-16 py-20">
        ...
        <p className='text-[#ffffff] text-[45px] font-bold mb-6'><span className='text-[#0DA574] text-[45px] font-bold'>Our Team</span> is Responsible <br /> for The Best Construction</p>
